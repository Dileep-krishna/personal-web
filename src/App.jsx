...
const App = () => {
  ...
  const linkedinUrl = "https://linkedin.com/in/dileepkrishna-t";
  const gmailUrl = "mailto:your.email@gmail.com";
    ...
    <div className="app">
      <div className="container">
        ...
        <div className="character-container">
          <div className={`boy-character ${animationStage} ${smiling ? 'smiling' : ''}`}>
            {/* Body */}
            ...
            <div className={`arm right-arm ${pointing ? 'pointing' : ''}`}></div>
            
            {/* Legs */}
            <div className={`legs ${animationStage}`}>
